package com.example.testcloudprovider.config;
...
public class GeneratorCodeConfig {
    ...
    public static void main(String[] args){
        //全局包名
        String packageName = "com.example.testcloudprovider1";
        // service生产策略。例如：user->UserService,设置成true:user->IUserService
        boolean serviceNameStartWithI = true;
        generateByTables(serviceNameStartWithI,packageName,"export_job");
    }
